...
export default function EditAnnouncementModal({ isOpen, onClose, onSuccess, announcement }: EditAnnouncementModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-[#7D1A1D] text-white py-4 px-6 flex items-center justify-between sticky top-0">
          <div>
            <h2 className="text-xl md:text-2xl font-bold font-serif">Edit Announcement</h2>
            <p className="text-sm font-serif opacity-90">Update announcement details</p>
          </div>
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? (
                ...
                <span className="text-lg font-medium">Update Announcement</span>
              )}
            </Button>
          </form>
        </div>
